...
class Power_log_model extends HS_Model {

    //获取结果集
    public function getPowerList($where=array(), $limit='20', $offset='0', $order_by='id desc',$fields="*")
    {
    ...
    //获取所有结果集
    public function getPowerAll($where=array(),$fields)
    {
    ...
    //获取单个
    public function checkPower($where=array(),$fields="*")
    {
    	return $this->select($fields)->where($where)->find();
    }
    
    //删除
    public function deletePower($where)
    {
    	return $this->where($where)->delete();
    }
    
    //编辑
    public function editPower($where,$data)
    {
    ...
    public function addId($where,$col,$value) {
    	...
    	return $this->db->update('power_log');
    }
}
?>
