...
<div class="main-content">
		<div class="breadcrumbs" id="breadcrumbs">
			...
			<ul class="breadcrumb">
				...
				<li><a href="<?=$this->work_url;?>">订单中心</a></li>
				<li><a href="<?=$this->work_url;?>">求职者待开工列表</a></li>
				<li>查看信息</li>
			</ul>
		</div>	
		<input type="hidden" name="message" id="message" value="<?=$message?>">
		<input type="hidden" name="admin_path" id="admin_path" value="<?=$admin_path?>">
		<input type="hidden" name="path" id="path" value="<?=$this->work_url;?>">
						...
						<div class="page-header"></div>
					 	<div class="form-group">
					   		<div class="col-sm-offset-1 col-sm-10">
								...
								<button type="button" onclick="nopass(9)" class="btn btn-sm btn-primary">未完工</button>
								<button type="button" onclick="nopass(8)" class="btn btn-sm btn-black">已完工</button>
