...
<div class="main-content">
		...
		<div class="page-content" style="margin-top:8px;">
			<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
				...
				<div class="visible-md visible-lg hidden-sm hidden-xs btn-group" style='margin: 72px 0 40px -36%;'>
					<div style="float:left;margin-right:30px;">
						<a href="<?=$admin_path;?>/jobhunter/edit_page/<?=$data['user_id'];?>" class='btn-pink3'><span  class="btn2 btn-xs bottom-ky ">用戶資料</span></a>
					</div>					
					<div style="float:left;margin-right:30px;">
						<a href="<?=$admin_path;?>/jobhunter/enroll_list/<?=$data['user_id'];?>" class='btn-pink2'><span class="btn2 btn-xs  bottom-ky ">投递职位</span></a>
					</div>						
				</div>
				<div class="page-header" style="height:180px;"></div>

				<div style="float:right;">
					<form action="<?=$this->gos_url;?>/<?=$data['user_id'];?>" method="post">
	...
	<script type="text/javascript">
		jQuery(function($) {
			...
			var oTable1 = $('#sample-table-2').dataTable({
	            ...
	            "sAjaxSource": admin_path+"/jobhunter/ajax_enroll_list?search_field="+search_field+"&user_id="+user_id, //给服务器发请求的url
