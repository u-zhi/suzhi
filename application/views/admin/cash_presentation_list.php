			...
			<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
				<div style="width:100%;">
					<div style="float:right;">
						<form action="/user_admin/withdraw/card_presentation_record" method="post">
							<div style="float:left;margin-right:10px;">
								<input type="text" id="search_field" name="search_field" placeholder="输入手机号码搜索"  value="<?=$search_field;?>">
							</div>
	...
	<script type="text/javascript">
		jQuery(function($) {
			...
			var oTable1 = $('#sample-table-2').dataTable({
				...
				"sAjaxSource": admin_path+"/withdraw/ajax_presentation_list?search_field="+search_field, //给服务器发请求的url
