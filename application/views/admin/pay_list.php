...
<!--			</div>-->
			<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
				<div style="width:100%;">				
					<div style="float:left;margin-right:30px;">
						<a href="/user_admin/pay/pay_list" class='btn-pink2'><span  class="btn2 btn-xs bottom-ky ">企业内推</span></a>
					</div>					
					<div style="float:left;margin-right:30px;">
					...
					<div style="float:left;margin-right:8px;">
						...
						<a href="/user_admin/pay/add_page"><span class="btn btn-xs btn-pink">添加企业内推服务</span></a>
						<?php }?>
					</div>
	...
	jQuery(function($) {
		...
		var oTable1 = $('#sample-table-2').dataTable({ 
            ...
            "sAjaxSource": admin_path+"/pay/ajax_pay_list?search_field="+search_field, //给服务器发请求的url
