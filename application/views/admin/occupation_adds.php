<?php include_once('header.php');?>
	<div class="main-content">
		...
		<div class="page-content" style="margin-top:18px;">							
			...
			<div class="row">
				<div class="col-xs-12">
					<form class="form-horizontal" enctype="multipart/form-data" role="form" method="post" action="/user_admin/occupation/adds"  onsubmit="return occupation_add_check()">
						<div class="form-group">
							<label for="title" class="col-sm-1 control-label">职位分类名称</label>
							<div class="col-sm-2">
