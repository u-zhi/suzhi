...
<div class="main-content">
		<div class="breadcrumbs" id="breadcrumbs">
			...
			<ul class="breadcrumb">
				...
				<li><a href="<?=$this->go_url;?>">首页管理</a></li>
		...
		<div class="page-content" style="margin-top:18px;">					
			...
			<div class="row">
				<div class="col-xs-12">
					<form class="form-horizontal" enctype="multipart/form-data" role="form" method="post" action="<?=$admin_path;?>/homepage/add"  onsubmit="return carousel_add_check()">
						<div class="form-group">
							<label  class="col-sm-1 control-label">图片</label>
							<div class="col-sm-2">
								<input type="hidden" class="form-control" id="img_url" name="img_url" value="">
						...
						<div class="form-group has-error">
							...
							<div class="col-sm-2">
								<span class="block input-icon input-icon-right">
									<input type="text" class="width-100" id="sort" name="sort" value="" >
						...
						<div class="form-group">
							...
							<div class="col-sm-2">
								<input type="text" class="width-100" id="link" name="link" value="">
							</div>
						</div>
