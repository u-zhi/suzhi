...
<div class="main-content">
    ...
    <input type="hidden" name="path" id="path" value="<?=$admin_path?>/pay/suzhi_list">
    <div class="page-content" style="margin-top:18px;">
        <div class="page-header">
            <h1 class="blue"><i class="icon-edit"></i> 添加速职充值档次</h1>
        </div>
        <div class="row">
            <div class="col-xs-12">
                <form class="form-horizontal" enctype="multipart/form-data" role="form" method="post" action="/user_admin/pay/suzhi_add" onsubmit="return pay_add_check()"  >
                    <div class="form-group">
                        <label  class="col-sm-1 control-label">速职币金额：</label>
                        <div class="col-sm-2">
