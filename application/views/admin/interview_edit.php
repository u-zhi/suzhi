...
<div class="main-content">
		<div class="breadcrumbs" id="breadcrumbs">
			...
			<ul class="breadcrumb">
				...
				<li><a href="<?=$this->gos_url;?>">求职者订单列表</a></li>
				<li>编辑信息</li>
			</ul>
		</div>	
		...
		<div class="page-content" style="margin-top:18px;">					
			...
			<div class="row">
				<div class="col-xs-12">
					<form class="form-horizontal" enctype="multipart/form-data" role="form" method="post" action="<?=$admin_path;?>/order/add"  onsubmit="return interview_add_check()">
						<input type="hidden" class="width-100" id="id" name="id" value="<?=$data['id'];?>">
						<div class="form-group">
							<label class="col-sm-1 control-label">面试时间</label>
							<div class="col-sm-2">
								<input style="cursor:pointer;" type="text" placeholder="请选择时间" class="Wdate" id="interview_time" name="interview_time"  id="d412" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" />
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-2">
								<input type="text" class="width-100" id="interview_address" name="interview_address" value="">
							</div>
						</div>
