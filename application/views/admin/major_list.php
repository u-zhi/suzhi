			...
			<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
				<div style="width:100%;">				
					<div style="float:left;margin-right:8px;">
						...
						<a href="add_pages"><span class="btn btn-xs btn-pink">添加学科</span></a>
						<a href="add_page"><span class="btn btn-xs btn-pink">添加专业</span></a>
						<?php }?>
					</div>
	...
	<script type="text/javascript">
		jQuery(function($) {
			...
			var oTable1 = $('#sample-table-2').dataTable({ 
	            ...
	            "sAjaxSource": admin_path+"/major/ajax_major_list?search_field="+search_field+"&parent_id="+parent_id, //给服务器发请求的url
