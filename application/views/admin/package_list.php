...
<div class="main-content">
		...
		<input type="hidden" name="path" id="path" value="<?=$this->go_url3;?>">	
...
<!--			</div>-->
			<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
				<div style="width:100%;">				
					...
					<div style="float:left;margin-right:30px;">
						<a href="/user_admin/pay/interview_list" class='btn-pink3'><span class="btn2 btn-xs  bottom-ky ">邀请面试</span></a>
					</div>						
					<div style="float:left;margin-right:30px;">
						<a href="/user_admin/pay/package_list" class='btn-pink2'><span class="btn2 btn-xs  bottom-ky ">套餐</span></a>
					</div>
                    <div style="float:left;margin-right:30px;">
					...
					<div style="float:left;margin-right:8px;">
						...
						<a href="/user_admin/pay/package_add_page"><span class="btn btn-xs btn-pink">添加企业套餐服务</span></a>
						<?php }?>
					</div>
					<div style="float:right;">		
						<form action="<?=$this->go_url3;?>" method="post">	
	...
	jQuery(function($) {
		...
		var oTable1 = $('#sample-table-2').dataTable({ 
            ...
            "sAjaxSource": admin_path+"/pay/ajax_package_list?search_field="+search_field, //给服务器发请求的url
            "aoColumns": [ //这个属性下的设置会应用到所有列，按顺序没有是空
	       	    {"mData": 'id'},
                {"mData": 'interview_id'}, //mData 表示发请求时候本列的列明，返回的数据中相同下标名字的数据会填充到这一列
                {"mData": 'innerpush_id'}, //mData 表示发请求时候本列的列明，返回的数据中相同下标名字的数据会填充到这一列
                {"mData": 'suzhicoin_id'},
