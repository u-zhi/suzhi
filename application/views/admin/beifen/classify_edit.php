<?php include_once('header.php');?>
	<div class="main-content">
		...
		<div class="page-content" style="margin-top:18px;">							
			...
			<div class="row">
				<div class="col-xs-12">			
					<form class="form-horizontal" enctype="multipart/form-data" role="form" method="post" action="<?=$admin_path?>/classify/edit"  onsubmit="return classify_edit_check()">
						...
						<div class="form-group has-error">
							...
							<div class="col-sm-2">
								<span class="block input-icon input-icon-right">
									<input type="text" class="width-100" id="classify_sort" name="classify_sort" value="<?=$data['classify_sort'];?>">
								</span>
							</div>													
