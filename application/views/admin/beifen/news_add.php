...
<div class="main-content">
		...
		<div class="page-content" style="margin-top:18px;">					
			...
			<div class="row">
				<div class="col-xs-12">
					<form class="form-horizontal" enctype="multipart/form-data" role="form" method="post" action="<?=$admin_path;?>/news/add"  onsubmit="return news_add_check()">	           																										
						...
						<div class="form-group has-error">
							...
							<div class="col-sm-3">
								<span class="block input-icon input-icon-right">
									<input type="text" class="width-100" id="news_sort" name="news_sort" value="99">
