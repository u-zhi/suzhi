					...
					<div style="float:right;">		
						<form action="<?=$this->go_url;?>" method="post">
							<div style="float:left;margin-right:10px;">
								<input type="text" id="search_field" name="search_field" placeholder="输入代理名称搜索"  value="<?=$search_field;?>">
							</div>								
	...
	<script type="text/javascript">
		jQuery(function($) {
			...
			var oTable1 = $('#sample-table-2').dataTable({ 
	            ...
	            "sAjaxSource": admin_path+"/three_level/ajax_three_list?search_field="+search_field+"&message_id="+message_id+"&message="+message, //给服务器发请求的url
	            ...
	            "aoColumnDefs": [//和aoColums类似，但他可以给指定列附近爱属性
	               {"bSortable": false, "aTargets": [7]},//（从0开始算） 不能排序
	        	]
			});
		});
	</script>
