...
<div class="main-content">
		<div class="breadcrumbs" id="breadcrumbs">
			...
			<ul class="breadcrumb">
				...
				<li><a href="<?=$this->go_url;?>">代理审核列表</a></li>
				<li>查看信息</li>
			</ul>
		</div>	
		...
		<div class="page-content" style="margin-top:18px;">					
			...
			<div class="row">
				<div class="col-xs-12">
					<form class="form-horizontal" enctype="multipart/form-data" role="form" method="post" action="<?=$admin_path;?>/audit/edit">	           																										
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<label style="margin-right:30px;"><input class="ace" type="radio" name="parent_status" value="2" checked="checked"/><span class="lbl"> 暂定</span></label>														
								<label style="margin-right:30px;"><input class="ace" type="radio" name="parent_status" value="3" /><span class="lbl"> 通过</span></label>
								<label><input class="ace" type="radio" name="parent_status" value="4" /><span class="lbl"> 拒绝</span></label>							
							</div>					
						</div>	
					 	<div class="form-group">
