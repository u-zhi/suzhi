	...
	<div class="main-content">
		<div class="breadcrumbs" id="breadcrumbs">
			...
			<ul class="breadcrumb">
				...
				<li><a href="<?=$this->go_url;?>">一级代理列表</a></li>
				<li>编辑信息</li>
			</ul>
		</div>
			...
			<div class="row">
				<div class="col-xs-12">			
					<form class="form-horizontal" enctype="multipart/form-data" role="form" method="post" action="<?=$admin_path?>/one_level/edit"  onsubmit="return one_edit_check()">
						...
						<div class="page-header">
							<h4 class="blue">   下级信息</h4>
						</div>							
						<div class="form-group">
							<label class="col-sm-1 control-label"></label>
							<table class="col-sm-5 price-td" style='border:1px solid #ddd;margin-bottom:20px;' width='50%'>
						 		<tr><td><b>级别</b></td><td><b>数量</b></td><td><b>查看</b></td></tr> 		
								<tr><td>二级代理</td><td><b><?=$two_count;?>个</b></td><td><b><a target="_blank" href="/user_admin/two_level/two_list/100/<?=$data['id'];?>"><span class="btn btn-xs btn-primary">查看列表</span></a></b></td></tr>	
								<tr><td>三级代理</td><td><b><?=$three_count;?>个</b></td><td><b><a target="_blank" href="/user_admin/three_level/three_list/100/<?=$data['id'];?>"><span class="btn btn-xs btn-primary">查看列表</span></a></b></td></tr>
								<tr><td>四级代理</td><td><b><?=$four_count;?>个</b></td><td><b><a target="_blank" href="/user_admin/four_level/four_list/100/<?=$data['id'];?>"><span class="btn btn-xs btn-primary">查看列表</span></a></b></td></tr>	
								<tr><td>五级代理</td><td><b><?=$five_count;?>个</b></td><td><b><a target="_blank" href="/user_admin/five_level/five_list/100/<?=$data['id'];?>"><span class="btn btn-xs btn-primary">查看列表</span></a></b></td></tr>
