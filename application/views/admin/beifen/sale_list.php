	...
	<script type="text/javascript">
		jQuery(function($) {
			...
			var oTable1 = $('#sample-table-2').dataTable({ 
	            ...
	            "sAjaxSource": admin_path+"/chart_goods/ajax_sale_list?start_time="+start_time+"&search_field="+search_field+"&classify_id="+classify_id, //给服务器发请求的url
	            "aoColumns": [ //这个属性下的设置会应用到所有列，按顺序没有是空
	                {"mData": 'id'},
	                {"mData": 'name'}, //mData 表示发请求时候本列的列明，返回的数据中相同下标名字的数据会填充到这一列
	                {"mData": 'classify_name'},
	                {"mData": 'total_sum'},
	                {"mData": 'total_time_sum'},
	                {"mData": 'pickup_sum'},
	                {"mData": 'pickup_time_sum'},
	            ],
