	...
	<script type="text/javascript">
		jQuery(function($) {
			...
			var oTable1 = $('#sample-table-2').dataTable({ 
	            ...
	            "sAjaxSource": admin_path+"/purchase/ajax_purchase_list?search_field="+search_field+"&order_status="+order_status, //给服务器发请求的url
	            ...
	            "aoColumnDefs": [//和aoColums类似，但他可以给指定列附近爱属性
	               {"bSortable": false, "aTargets": [8]},//（从0开始算） 不能排序
	        	]
			});
		});
	</script>
