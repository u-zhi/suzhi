					...
					<div style="float:right;">		
						<form action="<?=$this->go_url;?>" method="post">
							<div style="float:left;margin-right:10px;">
								<input type="text" id="search_field" name="search_field" placeholder="输入文案名称搜索"  value="<?=$search_field;?>">
							</div>								
	...
	<script type="text/javascript">
		jQuery(function($) {
			...
			var oTable1 = $('#sample-table-2').dataTable({ 
	            ...
	            "sAjaxSource": admin_path+"/casus/ajax_casus_list?search_field="+search_field+"&goods_id="+goods_id, //给服务器发请求的url
