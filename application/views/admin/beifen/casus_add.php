...
<div class="main-content">
		...
		<div class="page-content" style="margin-top:18px;">					
			...
			<div class="page-header">
				<h1 class="blue"><i class="icon-edit"></i> 添加文案</h1>
			</div>							
			<div class="row">
				<div class="col-xs-12">
					<form class="form-horizontal" enctype="multipart/form-data" role="form" method="post" action="<?=$admin_path;?>/goods/save_case"  onsubmit="return case_add_check()">	           																										
						<input type="hidden" id="goods_id" name="goods_id" class="width-100" value="<?=$data['id'];?>">
						...
						<div class="form-group">
							...
							<div class="col-sm-3">							
								<input type="text" class="width-100" id="title" name="title" value="">								
							</div>					
						</div>			
						<div class="form-group has-error">
							...
							<div class="col-sm-3">
								<span class="block input-icon input-icon-right">
									<input type="text" class="width-100" id="case_sort" name="case_sort" value="99">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<textarea id="editor" name="content" type="text/plain" style="height:360px;"></textarea>
							</div>													
						</div>
