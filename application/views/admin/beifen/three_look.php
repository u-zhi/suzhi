	...
	<div class="main-content">
		<div class="breadcrumbs" id="breadcrumbs">
			...
			<ul class="breadcrumb">
				...
				<li><a href="<?=$this->go_url;?>">三级代理列表</a></li>
				<li>编辑信息</li>
			</ul>
		</div>
					...
					<form class="form-horizontal" enctype="multipart/form-data" role="form" method="post" action="<?=$admin_path?>/one_level/edit"  onsubmit="return one_edit_check()">
						...
						<div class="form-group">
							...
							<table class="col-sm-5 price-td" style='border:1px solid #ddd;margin-bottom:20px;' width='50%'>
								...
								<tr><td>四级代理</td><td><b><?=$four_count;?>个</b></td><td><b><a target="_blank" href="/user_admin/four_level/four_list/300/<?=$data['id'];?>"><span class="btn btn-xs btn-primary">查看列表</span></a></b></td></tr>	
								<tr><td>五级代理</td><td><b><?=$five_count;?>个</b></td><td><b><a target="_blank" href="/user_admin/five_level/five_list/300/<?=$data['id'];?>"><span class="btn btn-xs btn-primary">查看列表</span></a></b></td></tr>
