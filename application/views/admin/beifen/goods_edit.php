...
<div class="main-content">
		...
		<div class="page-content" style="margin-top:18px;">					
			...
			<div class="row">
				<div class="col-xs-12">
					<form class="form-horizontal" enctype="multipart/form-data" role="form" method="post" action="<?=$admin_path;?>/goods/edit"  onsubmit="return goods_edit_check()">	           																										
						...
						<div class="form-group">
							...
							<div class="col-sm-2">
								...
								<?php foreach($classify_list as $k => $v) {?>
									<option value="<?=$v['id'];?>" <?php if($v['id'] == $data['classify_id']) echo 'selected="selected"';?>><?=$v['name'];?></option>											
								<?php }?>
								</select>
							</div>
						</div>		
						<div class="form-group">
							<label  class="col-sm-1 control-label">当前封面图</label>
							<div class="col-sm-4">
								<img id="bigic" src="<?php echo $data['images'];?>" style="max-height:160px;max-width:835px;" />
							</div>
						</div>	
						<div class="form-group">
			                <label  class="col-sm-1 control-label">封面图</label>
			                <div class="col-sm-3">
			                	<input type="hidden" class="form-control" id="good_logo" name="good_logo" value="<?=$data['good_logo'];?>">
						...
						<div class="form-group">
			             ...
			             <?php }?>					
						<div class="form-group">
							<label class="col-sm-1 control-label">上传图册</label>		
						...
						<input type="hidden" id="delete_image" name="delete_image" value="">			 	
					 	<div class="form-group">
						 	...
						 	<table class="col-sm-5 price-td" style='border:1px solid #ddd;margin-bottom:20px;' width='50%'>
								...
								<tr><td>一级代理</td><td><input type="text" class="width-80" id="one_price" name="one_price" value="<?=$data['one_price'];?>"><b>&nbsp;&nbsp;元</b></td></tr>
								<tr><td>二级代理</td><td><input type="text" class="width-80" id="two_price" name="two_price" value="<?=$data['two_price'];?>"><b>&nbsp;&nbsp;元</b></td></tr>	
								<tr><td>三级代理</td><td><input type="text" class="width-80" id="three_price" name="three_price" value="<?=$data['three_price'];?>"><b>&nbsp;&nbsp;元</b></td></tr>
								<tr><td>四级代理</td><td><input type="text" class="width-80" id="four_price" name="four_price" value="<?=$data['four_price'];?>"><b>&nbsp;&nbsp;元</b></td></tr>
								<tr><td>五级代理</td><td><input type="text" class="width-80" id="five_price" name="five_price" value="<?=$data['five_price'];?>"><b>&nbsp;&nbsp;元</b></td></tr>						
						 	</table>
					 	</div> 	
						<div class="form-group">
							<label class="col-sm-1 control-label">库存</label>
							<div class="col-sm-3">							
								<input type="text" class="width-100" id="stock_num" name="stock_num" value="<?=$data['stock_num'];?>">								
							</div>					
						</div>						 	
						<div class="form-group has-error">
							...
							<div class="col-sm-3">							
								<span class="block input-icon input-icon-right">
									<input type="text" class="width-100" id="purchase_num" name="purchase_num" value="<?=$data['purchase_num'];?>">								
						...
						<div class="form-group has-error">
							...
							<div class="col-sm-3">														
								<span class="block input-icon input-icon-right">
									<input type="text" class="width-100" id="pick_num" name="pick_num" value="<?=$data['pick_num'];?>">								
									<i class="icon-info-sign"></i>
								</span>
							</div>																
							<div class="help-block col-xs-12 col-sm-reset inline">
						...
						<div class="form-group has-error">
							...
							<div class="col-sm-3">														
								<span class="block input-icon input-icon-right">
									<input type="text" class="width-100" id="dc_price" name="dc_price" value="<?=$data['dc_price'];?>">								
									<i class="icon-info-sign"></i>
								</span>
							</div>																
							<div class="help-block col-xs-12 col-sm-reset inline">
						...
						<div class="form-group has-error">
							...
							<div class="col-sm-3">
								<span class="block input-icon input-icon-right">
									<input type="text" class="width-100" id="goods_sort" name="goods_sort" value="<?=$data['goods_sort'];?>">
									<i class="icon-info-sign"></i>
								</span>
							</div>									
							<div class="help-block col-xs-12 col-sm-reset inline">
						...
						<div class="form-group">
							...
							<div class="col-sm-3">														
								<label style="margin-right:30px;"><input class="ace" type="radio" name="is_show" value="2" <?php if($data['is_show'] == 2) echo 'checked="checked"'?> /><span class="lbl"> 上架</span></label>
								<label><input class="ace" type="radio" name="is_show" value="1" <?php if($data['is_show'] == 1) echo 'checked="checked"'?> /><span class="lbl"> 下架</span></label>							
							</div>					
						</div>													             
						<div class="form-group">
							<label for="content" class="col-sm-1 control-label">商品描述</label>
							<div class="col-sm-10">
								<textarea id="editor" name="intro" type="text/plain" style="height:360px;"><?=$data['intro'];?></textarea>
							</div>
						</div>				
