...
<div class="main-content">
    ...
    <input type="hidden" name="path" id="path" value="<?=$this->go_url4;?>">
    <div class="page-content" style="margin-top:8px;">
        ...
        <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
            <div style="width:100%;">
                ...
                <div style="float:left;margin-right:30px;">
                    <a href="/user_admin/pay/suzhi_list" class='btn-pink2'><span class="btn2 btn-xs  bottom-ky ">速职币</span></a>
                </div>
                <div class="page-header" style="height:100px;"></div>
                <div style="float:left;margin-right:8px;">
                    <?php if($authority['add_status'] == 2) {?>
                        <a href="/user_admin/pay/suzhi_add_page"><span class="btn btn-xs btn-pink">添加速职币套餐服务</span></a>
                    <?php }?>
                </div>
                <div style="float:right;">
                    <form action="<?=$this->go_url4;?>" method="post">
                        <div style="float:left;margin-right:10px;">
                            <input type="text" id="search_field" name="search_field" placeholder="输入开通速职币"  value="<?=$search_field;?>">
                        </div>
...
<script type="text/javascript">
    jQuery(function($) {
        ...
        var oTable1 = $('#sample-table-2').dataTable({
            ...
            "sAjaxSource": admin_path+"/pay/ajax_suzhi_list?search_field="+search_field, //给服务器发请求的url
