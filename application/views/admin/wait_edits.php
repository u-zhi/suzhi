...
<div class="main-content">
		<div class="breadcrumbs" id="breadcrumbs">
			...
			<ul class="breadcrumb">
				...
				<li><a href="<?=$this->wait_url;?>">订单中心</a></li>
				<li><a href="<?=$this->wait_url;?>">求职者待面试列表</a></li>
				<li>查看信息</li>
			</ul>
		</div>	
			...
			<div class="row">
				<div class="col-xs-12">
					<form class="form-horizontal" enctype="multipart/form-data" role="form" method="post" action="">
						...
						<hr>
						<div class="form-group">
							<label class="col-sm-1 control-label">面试时间</label>
							<div class="col-sm-2">
								<input type="text" class="width-100"  value="<?=$data['interview_time']?>" readonly="readonly">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-1 control-label">联系人</label>
							<div class="col-sm-2">
								<input type="text" class="width-100"  value="<?=$data['contact']?>" readonly="readonly">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-1 control-label">联系电话</label>
							<div class="col-sm-2">
								<input type="text" class="width-100"  value="<?=$data['contact_tel']?>" readonly="readonly">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-1 control-label">面试地点</label>
							<div class="col-sm-2">
								<input type="text" class="width-100"  value="<?=$data['interview_address']?>" readonly="readonly">
							</div>
						</div>
						<div class="page-header"></div>
					 	<div class="form-group">
					   		<div class="col-sm-offset-1 col-sm-10">
								...
								<button type="button" onclick="nopass(9)" class="btn btn-sm btn-primary">未面试</button>
								<button type="button" onclick="nopass(7)" class="btn btn-sm btn-black">面试不合适</button>
								<button type="button" onclick="nopass(2)" class="btn btn-sm btn-purple">面试录取</button>
	...
	<script type="text/javascript" >
		function nopass(status) {
			var id=$('#order_id').val();
			var data={'id':id,'current_status':status};
			$.ajax({
				type: "post",
				...
				success: function(data){
					if(data.status.succeed == 1){
						window.location.href="/user_admin/order/wait_list";
					}else{
