<?php include_once('header.php');?>
	<div class="main-content">
		...
		<div class="page-content" style="margin-top:18px;">							
			...
			<div class="row">
				<div class="col-xs-12">
					<form class="form-horizontal" enctype="multipart/form-data" role="form" method="post" action="/user_admin/node/add"  onsubmit="return node_add_check()">																
						<input type="hidden" id="pid" name="pid" value="<?=$pid;?>">
						<div class="form-group has-error">
							<label for="title" class="col-sm-1 control-label">节点名称</label>
							<div class="col-sm-2">
								<span class="block input-icon input-icon-right">
									<input type="text" class="width-100" id="node_name" name="node_name" value="">
						...
						<div class="form-group has-error">
							...
							<div class="col-sm-2">
								<select name="level" class="width-100">
									<option value="1">仅限总公司</option>
									<option value="2">分公司可用</option>						
								</select>
							</div>									
							<div class="help-block col-xs-12 col-sm-reset inline">
						...
						<div class="form-group has-error">
							...
							<div class="col-sm-2">
								<span class="block input-icon input-icon-right">
									<input type="text" class="width-100" id="node_sort" name="node_sort" value="99">
									<i class="icon-info-sign"></i>
								</span>
							</div>									
							<div class="help-block col-xs-12 col-sm-reset inline">
						...
						<?php }else {?>
							<input type="hidden" class="width-100" id="node_sort" name="node_sort" value="99">
						<?php }?>
					 	<div class="form-group">
