...
<!-- 				<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
				...
				<div class="visible-md visible-lg hidden-sm hidden-xs btn-group" style='margin: 124px 0 40px -5%;'>
					...
					<div style="float:left;margin-right:30px;">
						<a href="<?=$admin_path;?>/firm/company_buy/<?=$data['id']?>" class='btn-pink2'><span class="btn2 btn-xs  bottom-ky ">购买的服务</span></a>
					</div>							
					<div style="float:left;margin-right:30px;">
	...
	<script type="text/javascript">
		jQuery(function($) {
			...
			var oTable1 = $('#sample-table-2').dataTable({
	            ...
	            "sAjaxSource": admin_path+"/firm/ajax_company_buy_list?firm_id="+firm_id, //给服务器发请求的url
	            "aoColumns": [ //这个属性下的设置会应用到所有列，按顺序没有是空
		       	    {"mData": 'id'},
	                {"mData": 'buy_time'},
	                {"mData": 'xianmu'}, //mData 表示发请求时候本列的列明，返回的数据中相同下标名字的数据会填充到这一列
					{"mData": 'money'},//金额
					{"mData": 'pay_way'},//支付方式
					// {"mData": 'work_man'},//操作员
	            ],
