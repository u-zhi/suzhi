...
<div class="main-content">
		<div class="breadcrumbs" id="breadcrumbs">
			...
			<ul class="breadcrumb">
				...
				<li><a href="<?=$this->go_url;?>">全职列表</a></li>
				<li>新增信息</li>
			</ul>
		</div>	
		...
		<div class="page-content" style="margin-top:18px;">					
			...
			<div class="row">
				<div class="col-xs-12">
					<form class="form-horizontal" enctype="multipart/form-data" role="form" method="post" action="<?=$admin_path;?>/fulltime/add"  onsubmit="return goods_add_check()">
...
<!--						</div>-->
						...
						<div class="form-group has-error">
							...
							<div class="col-sm-2">
								<span class="block input-icon input-icon-right">
									<input type="text" class="width-100" id="person_demand" name="person_demand" value="">
							...
							<div class="col-sm-2">
								<select class="width-100" id="county_id" name="county_id">
									<?php foreach($county as $k => $v) {?>
										<option value="<?=$v['id'];?>"><?=$v['county_name'];?></option>
									<?php }?>
								</select>
							</div>
						</div>
						<div class="form-group has-error">
							...
							<div class="col-sm-2">
								<span class="block input-icon input-icon-right">
									<input type="text" class="width-100" id="commission" name="commission" value="">
									<i class="icon-info-sign"></i>
								</span>
							</div>
							<div class="help-block col-xs-12 col-sm-reset inline">
						...
						<div class="form-group has-error">
							...
							<div class="col-sm-2">
								<span class="block input-icon input-icon-right">
									<input type="text" class="width-100" id="salary" name="salary" value="">
									<i class="icon-info-sign"></i>
								</span>
							</div>
							<div class="help-block col-xs-12 col-sm-reset inline">
						...
						<div class="form-group">
							...
							<div class="col-sm-2">
								<input type="text" class="width-100" id="work_time" name="work_time" value="">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-1 control-label">上班时段</label>
							<div class="col-sm-2">
								<input type="text" class="width-100" id="work_schedule" name="work_schedule" value="">
							</div>
						</div>
						<div class="form-group has-error">
							...
							<div class="col-sm-2">
								<span class="block input-icon input-icon-right">
									<input type="text" class="width-100" id="view_times" name="view_times" value="" readonly="readonly">
									<i class="icon-info-sign"></i>
								</span>
							</div>
							<div class="help-block col-xs-12 col-sm-reset inline">
						...
						<div class="form-group has-error">
							...
							<div class="col-sm-2">
								<span class="block input-icon input-icon-right">
									<input type="text" class="width-100" id="recv_cv_times" name="recv_cv_times" value="" readonly="readonly">
									<i class="icon-info-sign"></i>
								</span>
							</div>
							<div class="help-block col-xs-12 col-sm-reset inline">
						...
						<div class="form-group has-error">
							...
							<div class="col-sm-2">
								<span class="block input-icon input-icon-right">
									<input type="text" class="width-100" id="fake_view_times" name="fake_view_times" value="" >
									<i class="icon-info-sign"></i>
								</span>
							</div>
							<div class="help-block col-xs-12 col-sm-reset inline">
						...
						<div class="form-group has-error">
							...
							<div class="col-sm-2">
								<span class="block input-icon input-icon-right">
									<input type="text" class="width-100" id="fake_recv_cv_times" name="fake_recv_cv_times" value="" >
									<i class="icon-info-sign"></i>
								</span>
							</div>
							<div class="help-block col-xs-12 col-sm-reset inline">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<textarea id="editor" name="job_description" type="text/plain" style="width: 260px;height: 180px"></textarea>
							</div>
						</div>
						<div class="form-group">
							<label for="content" class="col-sm-1 control-label">任职资格</label>
							<div class="col-sm-10">
								<textarea id="editor" name="duty_description" type="text/plain" style="width: 260px;height: 180px"></textarea>
							</div>
						</div>
						<div class="form-group">
							<label for="content" class="col-sm-1 control-label">福利待遇</label>
							<div class="col-sm-10">
								<textarea id="editor" name="benefits" type="text/plain" style="width: 260px;height: 180px"></textarea>
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-1 control-label">状态</label>
							<div class="col-sm-3">														
								<label style="margin-right:30px;"><input class="ace" type="radio" name="is_off_shelved" value="0" checked="checked" /><span class="lbl"> 上架</span></label>
								<label><input class="ace" type="radio" name="is_off_shelved" value="1" /><span class="lbl"> 下架</span></label>
							</div>					
						</div>
