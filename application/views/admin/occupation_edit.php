	...
	<div class="main-content">
		<div class="breadcrumbs" id="breadcrumbs">
			...
			<ul class="breadcrumb">
				...
				<li><a href="/user_admin/occupation/occupation_list">选项管理</a></li>
				<li><a href="/user_admin/occupation/occupation_list">职位列表</a></li>
				<li>查看信息</li>
			</ul>
		</div>
		...
		<div class="page-content" style="margin-top:18px;">							
			...
			<div class="row">
				<div class="col-xs-12">
					<form class="form-horizontal" enctype="multipart/form-data" role="form" method="post" action="/user_admin/occupation/edit"  onsubmit="return occupation_add_check()">
						<input type="hidden" class="width-100" id="id" name="id" value="<?=$data['id'];?>">
						<div class="form-group">
							<label for="title" class="col-sm-1 control-label">所属类别</label>
							<div class="col-sm-2">
						...
						<div class="form-group">
							<label for="title" class="col-sm-1 control-label">职位名称</label>
							<div class="col-sm-2">
