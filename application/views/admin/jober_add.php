<?php include_once('header.php');?>
	<div class="main-content">
		...
		<div class="page-content" style="margin-top:18px;">							
			...
			<div class="row">
				<div class="col-xs-12">
					<form class="form-horizontal" enctype="multipart/form-data" role="form" method="post" action="/user_admin/jobhunter_all/job_add_row" onsubmit="return job_add_row()" >
						<div class="form-group">
							<label class="col-sm-1 control-label">用户昵称</label>
							<div class="col-sm-2">
								<input type="text" class="width-100" id="nickname" name="nickname" value="">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-2">
								<input type="text" class="width-100" id="work_year" name="work_year" value="">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-1 control-label">期望薪资</label>
							<div class="col-sm-2">
								<input type="text" class="width-100" id="wage_lower" name="wage_lower" value="">
								<input type="text" class="width-100" id="wage_upper" name="wage_upper" value="">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-1 control-label">期望职位</label>
							<div class="col-sm-2">
								<input type="text" class="width-100" id="occupation" name="occupation" value="">
							</div>
						</div>
						<div class="form-group">
