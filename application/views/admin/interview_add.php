<?php include_once('header.php');?>
	<div class="main-content">
		...
		<input type="hidden" name="path" id="path" value="<?=$admin_path?>/pay/interview_list">
		<div class="page-content" style="margin-top:18px;">							
			<div class="page-header">
				<h1 class="blue"><i class="icon-edit"></i> 添加邀请面试服务</h1>
			</div>
			<div class="row">
				<div class="col-xs-12">
					<form class="form-horizontal" enctype="multipart/form-data" role="form" method="post" action="/user_admin/pay/interview_add" onsubmit="return pay_add_check()"  >
