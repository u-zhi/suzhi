		...
		<div class="page-content" style="margin-top:8px;">
			...
			<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
					<div class="visible-md visible-lg hidden-sm hidden-xs btn-group" style='margin: 20px 0 40px 20%;'>
							...
							<div style="float:left;margin-right:30px;">
								<a href="<?=$admin_path;?>/order/wait_list/<?php echo $data['order_id']?>" class='btn-pink2'><span class="btn2 btn-xs  bottom-ky ">简历投递的求职者</span></a>
							</div>							
							<div style="float:left;margin-right:30px;">
								<a href="<?=$admin_path;?>/order/people_list_tock/<?php echo $data['order_id']?>" class='btn-pink3'><span class="btn2 btn-xs  bottom-ky ">面试的求职者</span></a>
							</div>						
						</div>
	...
	<script type="text/javascript">
		jQuery(function($) {
			...
			var oTable1 = $('#sample-table-2').dataTable({
	            ...
	            "sAjaxSource": admin_path+"/order/ajax_wait_list?order_id="+order_id, //给服务器发请求的url
