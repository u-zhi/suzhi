...
<div class="main-content">
		...
		<input type="hidden" name="path" id="path" value="<?=$this->go_url_cooperation;?>">	
		<div class="page-content" style="margin-top:8px;">
			<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
				<div style="float:right;">
					<form action="<?=$this->go_url_cooperation;?>" method="post">
	...
	<script type="text/javascript">
		jQuery(function($) {
			...
			var oTable1 = $('#sample-table-2').dataTable({
	            ...
	            "sAjaxSource": admin_path+"/cooperation/ajax_cooperation_list?search_field="+search_field, //给服务器发请求的url
	            "aoColumns": [ //这个属性下的设置会应用到所有列，按顺序没有是空
					...
					{"mData": 'offer_money'},	//报价金额
					{"mData": 'has_number'},	//已完成几人
					{"mData": 'operate'},	//操作
	            ],
