	...
	<script type="text/javascript">
		jQuery(function($) {
			...
			var oTable1 = $('#sample-table-2').dataTable({
	            ...
	            "sAjaxSource": admin_path+"/jobhunter/ajax_jobhunter_list?search_field="+search_field+"&highest_degree="+highest_degree+"&province_id="+province_id+"&city_id="+city_id, //给服务器发请求的url
	            "aoColumns": [ //这个属性下的设置会应用到所有列，按顺序没有是空
		       	    {"mData": 'user_id'},	//序号
	                {"mData": 'phone_number'},	//手机号 //mData 表示发请求时候本列的列明，返回的数据中相同下标名字的数据会填充到这一列
	                {"mData": 'avatar_url'},	//头像
					{"mData": 'nickname'},	//昵称
					{"mData": 'gender_name'},	//性别
					{"mData": 'birthday'},	//生日
					{"mData": 'highest_degree_name'},	//最高学历
					{"mData": 'city_name'},	//所在城市
					{"mData": 'work_year'},	//工作年限
					{"mData": 'work_email'},	//工作邮箱
	                {"mData": 'operate'},	//操作
	            ],
