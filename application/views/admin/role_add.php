<?php include_once('header.php');?>
	<div class="main-content">
		...
		<div class="page-content" style="margin-top:18px;">								
			...
			<div class="row">
				<div class="col-xs-12">				
					<form class="form-horizontal" enctype="multipart/form-data" role="form" method="post" action="/user_admin/role/add"  onsubmit="return role_add_check()">
						<div class="alert alert-danger">
							<b><i class="icon-comment-alt"></i> 温馨提示：添加角色后可对此角色进行权限分配操作</b>
						</div>
						<div class="form-group">
							<label for="title" class="col-sm-1 control-label">角色名称</label>
							<div class="col-sm-2">
								<input type="text" class="width-100" id="role_name" name="role_name" value="">
							</div>
						</div>							
