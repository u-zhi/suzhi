...
//	{
//		$this->config->load("wx");
//		$account = $this->config->item("wx");
//
//		$this->appId = $account['appid'];
//		$this->appSecret = $account['appsecret'];
//	}

	public function webOauth($info = null, $scope = '', $fansInfo = '')
	{
		//获取公众号的密钥
		$CI =& get_instance();
		$CI->load->model('basic_config_model');
		$wechat_info = $CI->basic_config_model->checkBasic();
		$this->appId = $wechat_info['appid'];
		$this->appSecret = $wechat_info['appsecret'];
